...
Users may remove the last pipe `|> as_flextable()` from all examples. The author of this package are forced to have it in this vignette to make **`quarto`** rendering work.
